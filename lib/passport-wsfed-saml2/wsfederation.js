...
var WsFederation = module.exports = function WsFederation (realm, homerealm, identityProviderUrl, wreply, wctx) {
  this.realm = realm;
...
Object.defineProperty(WsFederation, 'wctx', {
  get: function () {
    return this.wctx;
  }
});
